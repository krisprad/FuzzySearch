...
template<typename T>
bool compare_ind_str(const  T& s1, const T& s2) {
	if (s1 == s2) {
...
void compare_strings() {
	...
	compare_ind_str(T("avatar "), T("Avathar"));  // match
	compare_ind_str(T("avatar"), T("avadar"));  // mismatch
	compare_ind_str(T("sampath"), T("sampat"));  // mismatch
	compare_ind_str(T("sampath"), T("sampat "));  // match
	compare_ind_str(T("Srinivas "), T("Sreenivas"));  // mismatch for ind_string but match for syl_string
	compare_ind_str(T("Srinivaas "), T("Sreenivass"));  // mismatch for ind_string but match for syl_string
}
